...
import {
  MapPin, Star, Heart, MessageCircle, Mail,
...
import { adaptListingDetail } from "../../lib/adapters";
...
export function VisualizarImoveis() {
  ...
  useEffect(() => {
    ...
    listingApi.detail(id)
      .then(data => {
        const adapted = adaptListingDetail(data);
        setImovel(adapted);
        setImoveisRelacionados([]);
        setAvaliacoes(avaliacoesMock.filter(a => a.imovelId == id));
      })
