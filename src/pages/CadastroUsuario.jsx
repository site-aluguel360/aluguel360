...
function LogoPainel() {
  return (
    <div className="flex min-h-[180px] items-center justify-center bg-primary px-8 py-10 text-center sm:min-h-[240px] lg:min-h-[560px]">
...
function Field({ label, className = "", ...props }) {
  return (
    <label className={`flex flex-col gap-1 font-['Inter'] text-[14px] font-medium leading-normal text-black sm:text-[16px] ${className}`}>
      {label}
      <Input
        className="h-[41px] rounded-[9px] border-primary bg-white px-2 font-['Inter'] text-[14px] font-light text-foreground shadow-none transition-all duration-200 placeholder:text-black/60 focus-visible:ring-1 focus-visible:ring-primary sm:text-[15px]"
        {...props}
      />
    </label>
  );
      ...
      <section className="m-auto grid w-full max-w-[1200px] overflow-hidden rounded-[8px] border border-[#515151]/80 bg-white shadow-[0_0_2.2px_0_#1A535C] lg:max-w-none lg:min-h-screen lg:rounded-none lg:border-none lg:shadow-none min-[1080px]:max-w-[1200px] min-[1080px]:min-h-0 min-[1080px]:rounded-[8px] min-[1080px]:border min-[1080px]:border-[#515151]/80 min-[1080px]:shadow-[0_0_2.2px_0_#1A535C] lg:grid-cols-2">
        ...
        <div className="flex min-h-[auto] items-center justify-center overflow-hidden px-5 py-8 sm:px-8 sm:py-10 lg:min-h-[560px] lg:px-10">
          ...
          {step === 3 && (
            ...
            >
              <Sun className="h-[75px] w-[75px] text-secondary" strokeWidth={1.25} />
              <h1 className="mt-2 font-['Poppins'] text-[28px] font-semibold leading-normal text-foreground/90 sm:text-[32px]">
                Sucesso!
              </h1>
              <p className="font-['Inter'] text-[14px] text-foreground/90 sm:text-[16px]">
                Cadastro realizado com sucesso!
              </p>
              <Button
                asChild
                className="h-10 mt-8 gap-2 rounded-[9px] bg-primary font-['Poppins'] text-[16px] font-normal text-accent shadow-[0_0_6.1px_0_rgba(0,0,0,0.41)] hover:bg-primary-light"
              >
                <Link to="/login">
