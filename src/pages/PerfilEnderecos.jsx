              ...
              {enderecosMock.map((endereco) => (
                ...
                >
                  <div className="mb-3 flex items-center justify-between">
                    <span className="inline-block rounded-full bg-teal-light/20 px-3 py-1 font-['Inter'] text-[12px] font-semibold text-secondary">
                      {endereco.tipo}
                    </span>
                  </div>
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    <p className="font-['Inter'] text-[14px] text-foreground/70">
