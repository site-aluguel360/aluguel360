...
export function Home() {
  ...
  const [imoveisMaisAcessados, setImoveisMaisAcessados] = useState([]);

  useEffect(() => {
    getImoveis().then(data => {
      // Pega os 3 primeiros
      setImoveisMaisAcessados(data.slice(0, 3));
    });
  }, []);
    ...
    <>
      ...
      <section className="relative h-[500px] flex items-center justify-center text-center text-white pb-16">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <Button size="lg" className="bg-secondary hover:bg-primary text-white text-lg px-8">
            <Link to="/resultados">
              Explorar Imóveis
            </Link>
          </Button>
        ...
        <div className="bg-white rounded-3xl p-8 md:p-10 shadow-xl border border-gray-100">
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {imoveisMaisAcessados.map((imovel) => (
                <CardImovel key={imovel.id} {...imovel} variant="compact" />
              ))}
            </div>
          </section>
          ...
          <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16 text-center">
            ...
            <div className="p-8 border rounded-2xl hover:border-secondary transition-colors hover:-translate-y-1 duration-300">
              ...
              <p className="text-muted-foreground text-sm mb-6 h-10">Aproveite ofertas e contate o proprietário</p>
              <Link to="/login">
                <Button size="sm" className="bg-secondary hover:bg-primary text-white w-full">Acessar minha conta</Button>
              </Link>
            </div>
            <div className="p-8 border rounded-2xl hover:border-secondary transition-colors hover:-translate-y-1 duration-300">
            ...
            <div className="p-8 border rounded-2xl hover:border-secondary transition-colors hover:-translate-y-1 duration-300">
              ...
              <p className="text-muted-foreground text-sm mb-6 h-10">Aproveite ofertas e contate o proprietário</p>
              <Button size="sm" className="bg-secondary hover:bg-primary text-white w-full">Ver a lista</Button>
            </div>
          </section>
